$(function() {
    ...
    $('#container-cookies').append('<div id="cookies" class="cookies"><div class="cookies_wrapper"><a class="close" title="close" href="javascript:;"></a><p class="copy">This site uses cookies to enhance the user experience. To find out more and set your preferences, please click here. If you agree to our use of <a class="ck" href="#">cookie</a>, please continue to browse our site.</p></div></div>');
...
(function($) {
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() { $(".vd-img").css("display", "none"); }, 5000);
        ...
        //$("p .m-info").click(function () {
        //    $(this).removeClass("active");
        //    if ($(this).hasClass("active")) {
        //        $("this").removeClass("active");
        //        $('.info-main').slideUp(600);

        //    } else {
        //        $('.info-main').slideDown(600);
        ...
        $(".m-info").click(function(e) {
            ...
            $(this).parent().parent().find('.mi-detail').slideDown(600);
        });
        $(".mc-close").click(function() {
            setTimeout(function() {
                //alert("Hello"); 
                $('.m-info').removeClass('ac');
                $('.mi-detail').slideUp(600);
            }, 800);
        });
        ...
        if ($('.links2-row-block.links3 ul').length > 0) {
            $('.links2-row-block.links3 ul').slick({
                speed: 300,
                slidesToShow: 1,
                slidesToScroll: 1,
                autoplay: false,
        ...
        if ($('.double-img-box ul').length > 0) {
            $('.double-img-box ul').slick({
                speed: 300,
                slidesToShow: 1,
                slidesToScroll: 1,
                autoplay: false,
        ...
        if ($('.links2-row-block.imgs2-row.imgs2-slide ul').length > 0) {
            $('.links2-row-block.imgs2-row.imgs2-slide ul').slick({
                speed: 300,
                slidesToShow: 1,
                slidesToScroll: 1,
                autoplay: false,
