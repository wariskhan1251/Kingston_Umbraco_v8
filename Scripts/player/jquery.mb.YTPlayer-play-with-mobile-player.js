 ...
 ****************************************************/
        ...
        jQuery.mbYTPlayer = {
            ...
            buildPlayer: function (options) {
                ...
                return this.each(function () {
                    ...
                    */
                     ...
                     */
                    if (YTPlayer.isPlayer) {
                        YTPlayer.inlinePlayButton = jQuery('<div/>').addClass('inlinePlayButton ir').html(jQuery.mbYTPlayer.controls.play);
                        ...
                        YTPlayer.inlinePlayButton.on('click', function (e) {
                           ...
                           //$('header').addClass('nav-up');
                            //$(".description.center.vdiodes").hide();
                                        ...
                                        */
                                        ...
                                        switch (state) {
                                            ...
                                            case 2:
                                                ...
                                                //$(".description.center.vdiodes").show();
                                                break;
            ...
            getDataFromAPI: function (YTPlayer) {
                ...
                if (YTPlayer.isPlayer && !YTPlayer.opt.autoPlay) { //&& ( !jQuery.mbBrowser.mobile && !jQuery.isTablet )
                    YTPlayer.loading = jQuery('<div/>').addClass('loading ir').html('Loading').hide();
 ...
 ___________________________________________________________________________________________________________________________________________________*/
    ...
    (function (b) {
    b.simpleSlider = {
        defaults: { initialval: 0, maxVal: 100, orientation: "h", readonly: !1, callback: !1 }, events: { start: b.browser.mobile ? "touchstart" : "mousedown", end: b.browser.mobile ? "touchend" : "mouseup", move: b.browser.mobile ? "touchmove" : "mousemove" }, init: function (c) {
            return this.each(function () {
                ...
                d.prepend(e); a.level = e; d.css({ cursor: "default" }); "auto" == a.opt.maxVal && (a.opt.maxVal = b(a).outerWidth()); d.updateSliderVal(); a.opt.readonly || (d.on(b.simpleSlider.events.start, function (c) { b.browser.mobile && (c = c.changedTouches[0]); a.canSlide = !0; d.updateSliderVal(c); "h" == a.opt.orientation ? d.css({ cursor: "col-resize" }) : d.css({ cursor: "row-resize" }); b.browser.mobile || (c.preventDefault(), c.stopPropagation()) }), b(document).on(b.simpleSlider.events.move, function (c) {
                    b.browser.mobile && (c = c.changedTouches[0]);
                    a.canSlide && (b(document).css({ cursor: "default" }), d.updateSliderVal(c), b.browser.mobile || (c.preventDefault(), c.stopPropagation()))
            ...
            checkForStart: function (YTPlayer) {
                ...
                YTPlayer.checkForStartAt = setInterval(function () {
                    ...
                    if (YTPlayer.player.getDuration() > 0 && YTPlayer.player.getCurrentTime() >= startAt && canPlayVideo) {
                        ...
                        if (YTPlayer.isPlayer && !YTPlayer.opt.autoPlay && (YTPlayer.loading && YTPlayer.loading.length)) {
                            YTPlayer.loading.html('Ready');
							YTPlayer.inlinePlayButton.fadeIn();
                            setTimeout(function () {
                                YTPlayer.loading.fadeOut()
                            }, 100)
                        }
