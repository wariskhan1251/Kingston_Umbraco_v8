...
(function ($) {
    $(window).on("load", function () {
        if ($('.pb-box .text-column').length > 0) {
            ...
            $(".pb-box .text-column").mCustomScrollbar({
                axis: "y",
                theme: "dark-thick",
            ...
            function myCustomFn(el) {
                ...
                //$('.pb-box .text-column ul li').each(function (index) {
                //    //$('.offsetposend').html($(this).outerHeight());
                //    if (scrollpositionCurrent >= $(this).offset().top + $(this).outerHeight() - window.innerHeight) {
                //        alert('end reached');
                //    }
                //});
                ...
                //        $(".pb-box .img-box").eq(index).removeClass("line");
                //    }
                //    else {
                ...
                $('.pb-box .text-column ul li').each(function (index) {
                    if (posopacity.top >= $(this).offset().top && posopacity.top <= $(this).next().offset().top - 80) {
                        $(this).addClass("dim");
                        $(".pb-box .img-box").removeClass("active");
                        $(".pb-box .img-box").eq(index).addClass("active");
                        $(".pb-box .img-box").eq(index).addClass("line");
