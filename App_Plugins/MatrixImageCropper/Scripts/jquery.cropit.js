...
//    $(".cropit-image-preview").width(width);
//    $(".cropit-image-preview").height(height);
//}
...
(function ($) {
    ...
    Zoomer = function () {
        ...
        Zoomer.prototype.setup = function (imageSize, previewSize, exportZoom, options) {
            ...
            if ((options != null ? options.minZoom : void 0) === "fit") {
                ...
                this.minZoom = widthRatio < heightRatio ? widthRatio : widthRatio;
            }
    ...
    Cropit = function () {
        ...
        Cropit.prototype.onImageLoaded = function () {
            ...
            //var fileNameuploaded = document.getElementById("uploadfile").value;

            ////alert($("input.cropit-image-input"));
            ////var fileNameuploaded = $(".cropit-image-input").val();

            ////if (fileNameuploaded.length > 0) {
            ////    var arrfileNameuploadedSplitted = fileNameuploaded.split('\\');
            ////    if (arrfileNameuploadedSplitted.length > 0)
            ////        fileNameuploaded = arrfileNameuploadedSplitted[arrfileNameuploadedSplitted.length - 1];

            ////    $("#hdnUploadedImageURLDirty").val(fileNameuploaded);
            ////}

            //document.getElementById("Div1").value = fileNameuploaded;

            //alert(document.getElementById("Div1").value);
            //$("#<%=hdnUploadedImageURL.ClientID%>").val();
            ...
            //var hideuploadbtn = document.getElementById('uploadfile').hidden = true
            this.imageSize = {
                w: this.image.width,
                h: this.image.height
            };
